...
namespace StockAlert.helper 
{
    class GoogleFinanceApiConnector 
    {
        ...
        // {
        //     HttpResponseMessage response = await client.PostAsJsonAsync("info?q="+ticker, product);
        ...
        //     client.BaseAddress = new Uri("https://www.google.com/finance/");
